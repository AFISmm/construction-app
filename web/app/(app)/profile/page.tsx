...
export default function ProfilePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setMsg(res.ok
      ...
      : { ok: false, text: "Failed to save profile." });
  }

  function f(k: keyof Profile, val: string) {
    setForm(p => ({ ...p, [k]: val }));
  }

  if (!loaded) return <p className="text-gray-400">Cargando…</p>;

  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold text-white mb-6">Extended Profile</h1>
