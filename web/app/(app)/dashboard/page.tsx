...
async function getDashboardData(projectId: number) {
  ...
  return lines.map(l => ({
    ...
    adjusted: toNum(l.change_order_amount) > 0 ? toNum(l.change_order_amount) : toNum(l.budgeted_amount),
    paid: l.expenses.reduce((s, e) => s + toNum(e.amount), 0),
  }));
}
